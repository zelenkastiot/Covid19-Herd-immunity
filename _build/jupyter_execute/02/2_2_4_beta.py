# Интерактивен график параметар $\beta$
***
...
sliders = [dict(
    active = 5,
    currentvalue = {'prefix':"Oчекуваниот број на луѓе кои заразена личност заразува на ден  &#x2192; <i>&#946; =</i> <b>"},
    pad = {"t": 90, "b": 10},
    steps = steps
)]

# Setup the layout of the figure
layout = go.Layout(title = 'SIR модел (1000 луѓе); \t <i>&#946;</i>',
                  title_x = 0.5, 
                  xaxis_title='<i>t</i>',
...
fig1_1_c = dict(data=data, layout=layout)
plot(fig1_1_c, filename = 'fig1_1_c.html', config = config)
display(HTML('fig1_1_c.html'))