# Интерактивен график параметар $D$
*** 
$D$**:** бројот на денови што личноста ја чува во себе болеста и може да истата да ја шири 
...
plot(fig1_1_a, filename = 'fig1_1_a.html', config = config)
display(HTML('fig1_1_a.html'))