...
Иако изгледаат како да се комплетно случајни овие ширења, сите вакви заразни болести (вируси) споделуваат некои **карактеристки**: овие карактеристки всушност се толку слични меѓу себе што математичките својста се апликативни во други процеси што немаат врска со биологија, а сепак имаат некое својство на ширење (компјутерски вируси и ширење на информации[[5]](https://ieeexplore.ieee.org/document/130801); лажни вести[[6]](https://www.scientificamerican.com/article/how-fake-news-goes-viral-mdash-heres-the-math/)). 

```{admonition} Што е епидемија, а што пандемија? 
...
```{admonition} Илустрација на периодите на заразеност
:class: tip
...
width: 85%
align: center
name: Disease progression over time
---
Прогресија на заразеноста во едница време
```

Фигурата иако е соодветен начин за визуелно да ги доловиме фазите во едница време, можеби кој го дадовме е некое наше толкување. Прецизните дефиниции  [[7]](https://nccid.ca/publications/glossary-terms-infectious-disease-modelling-proposal-consistent-language/#:~:text=The%20latent%20period%20is%20defined,be%20infected%20but%20not%20infectious.) за периодите низ кои минува заразена личност се:
